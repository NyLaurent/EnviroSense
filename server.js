...
`));
    ...
    console.log(chalk.green('✨ Connected to SQLite database successfully!'));
    console.log(chalk.yellow('⚡ System Status:'));
    console.log(chalk.blue('   • Database: ') + chalk.green('Online'));
    console.log(chalk.blue('   • MQTT: ') + chalk.green('Ready'));
    console.log(chalk.blue('   • Server: ') + chalk.green('Running'));
    console.log('\n' + chalk.gray('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━'));
    createTables();
  }
});
...
// Serve index.html from the current directory instead of public
app.get('/', (req, res) => {
